...
pub fn verify<T: Digest + Default>(compiled_circuit: &CompiledCircuit, proof: Proof) -> Result<(), String> {
    println!("Verifying...");
    ...
    let (alpha, beta, gamma, evaluation_challenge, v, u) = verify_challenges::<T>(&proof, &compiled_circuit);
    ...
    let p_i_e = compiled_circuit.gate_constraints().pi_x().evaluate(&evaluation_challenge);
    ...
    let d_line2 = proof.z_commit.mul((proof.bar_a + beta * evaluation_challenge + gamma)
        * (proof.bar_b + beta * compiled_circuit.copy_constraints().k1() * evaluation_challenge + gamma)
        * (proof.bar_c + beta * compiled_circuit.copy_constraints().k2() * evaluation_challenge + gamma)
    ...
    let d_line4 = (proof.t_lo_commit + proof.t_mid_commit.mul(evaluation_challenge.pow(&BigInt::new([proof.degree as u64 + 1])))
        + proof.t_hi_commit.mul(evaluation_challenge.pow(&BigInt::new([proof.degree as u64 * 2 + 2])))).mul(z_h_e);
    ...
    let pairing_right_side = Bls12_381::pairing(
        (proof.w_ev_x_commit.clone().mul(evaluation_challenge) + proof.w_ev_wx_commit.clone().mul(u * evaluation_challenge * w)
            + f - e).0,
...
fn verify_challenges<T: Digest + Default>(proof: &Proof, compiled_circuit: &CompiledCircuit) -> (Fr, Fr, Fr, Fr, Fr, Fr) {
    let scheme = KzgScheme::new(compiled_circuit.srs());
...
mod tests {
    ...
    fn verifier_accepted_test_01() {
        ...
        let compile_circuit = Circuit::default()
            .add_multiplication_gate((1, 0, Fr::from(3)), (0, 0, Fr::from(3)), (0, 3, Fr::from(9)), Fr::from(0))
            .add_multiplication_gate((1, 1, Fr::from(4)), (0, 1, Fr::from(4)), (1, 3, Fr::from(16)), Fr::from(0))
            .add_multiplication_gate((1, 2, Fr::from(5)), (0, 2, Fr::from(5)), (2, 3, Fr::from(25)), Fr::from(0))
            .add_addition_gate((2, 0, Fr::from(9)), (2, 1, Fr::from(16)), (2, 2, Fr::from(25)), Fr::from(0))
            .compile()
            .unwrap();
    ...
    fn verifier_rejected_test_01() {
        ...
        let compile_circuit = Circuit::default()
            ...
            .add_multiplication_gate((1, 1, Fr::from(4)), (0, 1, Fr::from(4)), (1, 3, Fr::from(16)), Fr::from(0))
            .add_multiplication_gate((1, 2, Fr::from(5)), (0, 2, Fr::from(5)), (2, 3, Fr::from(25)), Fr::from(0))
            .add_addition_gate((2, 0, Fr::from(9)), (2, 1, Fr::from(16)), (2, 2, Fr::from(20)), Fr::from(0))
            .compile()
            .unwrap();
    ...
    fn verifier_accepted_test_02() {
        ...
        let circuit = Circuit::default()
            .add_multiplication_gate((0, 1, Fr::from(1)), (1, 0, Fr::from(2)), (0, 3, Fr::from(2)), Fr::from(0))
            .add_multiplication_gate((1, 1, Fr::from(1)), (0, 0, Fr::from(1)), (0, 2, Fr::from(1)), Fr::from(0))
            .add_multiplication_gate((2, 1, Fr::from(1)), (2, 6, Fr::from(3)), (1, 3, Fr::from(3)), Fr::from(0))
            .add_addition_gate((0, 4, Fr::from(2)), (2, 2, Fr::from(3)), (0, 5, Fr::from(5)), Fr::from(0))

            .add_multiplication_gate((2, 0, Fr::from(2)), (1, 4, Fr::from(3)), (1, 5, Fr::from(6)), Fr::from(0))
            .add_addition_gate((2, 3, Fr::from(5)), (2, 4, Fr::from(6)), (2, 5, Fr::from(11)), Fr::from(0))
            .add_constant_gate((0, 6, Fr::from(3)), (1, 6, Fr::from(0)), (1, 2, Fr::from(3)), Fr::from(0));
    ...
    fn verifier_accepted_test_03() {
        // check xyz = 6
        let compile_circuit = Circuit::default()
            .add_multiplication_gate((0, 0, Fr::from(1)), (1, 0, Fr::from(2)), (0, 1, Fr::from(2)), Fr::from(0))
            .add_multiplication_gate((2, 0, Fr::from(2)), (1, 1, Fr::from(3)), (2, 1, Fr::from(6)), Fr::from(0))
            .compile()
            .unwrap();
